...
Continue looking for patterns, analyzing gender in novels. Research
questions. 
Some new methods in NLTK
prep for Data analysis next week

Review NLTK methods - 10 min
- similar, concordance, common_contexts, distribution_plot, 
- common_contexts([])
- collocations()

Teach FreqDist - 10 min
- to find most common words & plot them
#+BEGIN_SOURCE python
import matplotlib
%matplotlib inline 
...
*** TODO March 27
Looking for patterns in a structured way
Developing research questions from these patterns
---

Freewrite - 5 min - developing research questions. 
- What do you want to know about this data? Based on our exploration
  so far, what kind of research questions could we ask about our data?

Pair and share - 10 min
Pick one to share with the larger group. 
